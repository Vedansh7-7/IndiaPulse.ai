...
KPI_CONTRACT = {
    ...
    "cancellation_rate": {
        ...
        "definition": "Share of orders placed in the week that were cancelled.",
        "formula": "mean(order_status == 'canceled') over all orders placed",
        "unit": "rate",
        "grain": "order",
        "sources": ["orders"],
        "cadence": "weekly",
        "direction": "lower is better",
        "material_threshold": "a change past 1 percentage point",
        "drivers": ["stock availability", "payment failure", "delivery estimate",
                    "customer intent"],
        "owner": "Commerce",
        "access": "internal",
    },
    "items_per_order": {
        ...
        "definition": "Mean number of line items on a delivered order.",
        "formula": "mean(count of order items) per order, by purchase week",
        "unit": "items",
        "grain": "order",
        "sources": ["order_items", "orders"],
        "cadence": "weekly",
        "direction": "higher is better",
        "material_threshold": "a change past 0.1 items",
        "drivers": ["basket building", "product mix", "promotions"],
        "owner": "Commerce",
        "access": "internal",
    },
    "revenue": {
